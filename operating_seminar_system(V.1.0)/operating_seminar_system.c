...
char *Dynamic_stdin() {
    char Data[1024];
    if (fgets(Data, sizeof(Data), stdin) == NULL) return NULL;
    Data[strcspn(Data, "\n")] = 0;
...
void showMenu(User *user) {
    ...
    while(1) {
        ...
        if (strcmp(user->role,"Admin")==0) {
            ...
            switch(choice) {
                case 1: addSeminar(); break;
                case 2: searchSeminar(); break;
                case 3: updateSeminar(); break;
                case 4: deleteSeminar(); break;
                case 0: return;
            ...
            scanf("%d",&choice); clearBuffer();
            switch(choice) {
                case 1: manageSeminar(); break;
                case 2: approveParticipants(); break;
                case 3: searchSeminar(); break;
                case 0: return;
                default: printf("Invalid choice.\n"); break;
            }
        }
            ...
            scanf("%d",&choice); clearBuffer();
            switch(choice) {
                case 1: viewMySeminars(); break;
                case 2: uploadSlides(); break;
